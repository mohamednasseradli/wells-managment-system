<x-header title="Sender Dashboard | Areas" />

    {{-- Toggle Sidebar icon --}}
    <div class="toggle-sidebar">
        <i class="fa-solid fa-bars fa-lg"></i>
    </div>
    <div class="sender-users container-fluid "  style="min-height: 100vh">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            @foreach ($area->trunks as $trunk)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('trunk-wells', $trunk->id) }}" class="btn btn-primary me-3">
